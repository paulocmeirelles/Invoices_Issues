...
_TEXTS = {
    "US": {
        ...
        "factors_linked_to_reversal": "Factors linked to reversal",
        "reversal_model_note": "The dataset does not include a separate partial/total reversal label, so this view highlights the factors linked to whether an invoice is reversed at all.",
    ...
    "PT": {
        ...
        "factors_linked_to_reversal": "Fatores ligados à reversão",
        "reversal_model_note": "O conjunto de dados não inclui um rótulo separado para reversão parcial/total, então esta visão destaca os fatores associados à existência de uma reversão.",
